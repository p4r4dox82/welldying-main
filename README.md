...
클라이언트는 memento AWS의 S3 서비스에서, 정적 웹사이트로서 https://mymemento.kr 에 배포되어 있습니다. (서버가 실행되고 있는 EC2에서 nginx proxy를 적절히 이용해서 같이 배포되는 게 더 바람직하지만, 임시로 이 방법으로 배포하고 있습니다.) 보안 연결 (https) 제공은 AWS Cloudfront에서 하고 있습니다.
