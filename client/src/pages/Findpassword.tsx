...
import { getUserid, modifyUserPassword } from '../etc/api/user';
...
function Findpassword() {
    ...
    let [, user] = usePromise(() => getUserid(username), [username]);
            ...
            <div className = 'signup_form'>
                ...
                <form className='signupForm margin_33px'>
                    ...
                    {isMobile ? 
                        <>
                    <div className={'row'} >
                        <div className='label flex'>아이디</div>
                    ...
                    <button type='submit' className='findButton' onClick={async (e) => {
                        ...
                        } else if(user && (user.name !== name || user.birthYear !== birthYear || user.birthMonth !== birthMonth || user.birthDate !== birthDate || user.cellphone !== ('+82' + cellphone.slice(1))))
